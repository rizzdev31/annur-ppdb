...
<div class="p-6">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600">Perbarui informasi ekstrakurikuler</p>
    </div>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <textarea name="deskripsi" 
                              id="deskripsi" 
                              rows="5"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi', $ekstrakurikuler->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" 
                               ...
                               id="is_active" 
                               value="1"
                               {{ old('is_active', $ekstrakurikuler->is_active) ? 'checked' : '' }}
