...
@section('title', 'Edit Tahapan Pendaftaran')
...
<div class="p-6">
    ...
    <div class="mb-8">
        <div class="flex items-center mb-4">
            ...
            <h1 class="text-3xl font-bold text-gray-800">Edit Tahapan Pendaftaran</h1>
        </div>
        <p class="text-gray-600">Perbarui informasi tahapan pendaftaran</p>
    </div>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <textarea name="deskripsi" 
                              id="deskripsi" 
                              rows="5"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi', $tahapan->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" 
                           name="urutan" 
                           id="urutan" 
                           value="{{ old('urutan', $tahapan->urutan) }}"
                           min="1"
...
<script>
// Initialize icon preview with current value
